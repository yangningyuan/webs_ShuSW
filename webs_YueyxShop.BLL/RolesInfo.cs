...
namespace webs_YueyxShop.BLL
{
    ...
    {
        private readonly IRolesInfo dal = DataAccess.CreateRolesInfo();
        public RolesInfo()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        {
            return dal.DeleteList(Common.PageValidate.SafeLongFilter(r_IDlist, 0));
        }
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public webs_YueyxShop.Model.RolesInfo GetModelByCache(Guid r_ID)
        {

            string CacheKey = "RolesInfoModel-" + r_ID;
            ...
            return (webs_YueyxShop.Model.RolesInfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<webs_YueyxShop.Model.RolesInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<webs_YueyxShop.Model.RolesInfo> DataTableToList(DataTable dt)
        {
            List<webs_YueyxShop.Model.RolesInfo> modelList = new List<webs_YueyxShop.Model.RolesInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                webs_YueyxShop.Model.RolesInfo model;
        ...
        {
            return dal.UpdateState(r_StateCode, r_ID);
        }
         /// <summary>
        /// 判断是否存在同名
        /// </summary>
