...
namespace webs_YueyxShop.BLL
{
	...
	{
		private readonly IProductAppraiseBase dal=DataAccess.CreateProductAppraiseBase();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public webs_YueyxShop.Model.ProductAppraiseBase GetModelByCache(int pa_ID)
		{
			
			string CacheKey = "ProductAppraiseBaseModel-" + pa_ID;
			...
			return (webs_YueyxShop.Model.ProductAppraiseBase)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<webs_YueyxShop.Model.ProductAppraiseBase> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<webs_YueyxShop.Model.ProductAppraiseBase> DataTableToList(DataTable dt)
		{
			List<webs_YueyxShop.Model.ProductAppraiseBase> modelList = new List<webs_YueyxShop.Model.ProductAppraiseBase>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				webs_YueyxShop.Model.ProductAppraiseBase model;
        ...
        public List<Model.ProductAppraiseBase> GetModelListByskuId(string p)
        {
