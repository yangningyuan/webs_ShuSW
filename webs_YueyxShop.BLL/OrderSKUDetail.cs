...
namespace webs_YueyxShop.BLL
{
	...
	{
		private readonly IOrderSKUDetail dal=DataAccess.CreateOrderSKUDetail();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public webs_YueyxShop.Model.OrderSKUDetail GetModelByCache(int os_ID)
		{
			
			string CacheKey = "OrderSKUDetailModel-" + os_ID;
			...
			return (webs_YueyxShop.Model.OrderSKUDetail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<webs_YueyxShop.Model.OrderSKUDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<webs_YueyxShop.Model.OrderSKUDetail> DataTableToList(DataTable dt)
		{
			List<webs_YueyxShop.Model.OrderSKUDetail> modelList = new List<webs_YueyxShop.Model.OrderSKUDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				webs_YueyxShop.Model.OrderSKUDetail model;
