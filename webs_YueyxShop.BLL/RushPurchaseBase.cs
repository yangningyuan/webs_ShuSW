...
namespace webs_YueyxShop.BLL
{
	...
	{
		private readonly IRushPurchaseBase dal=DataAccess.CreateRushPurchaseBase();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public webs_YueyxShop.Model.RushPurchaseBase GetModelByCache(int rp_ID)
		{
			
			string CacheKey = "RushPurchaseBaseModel-" + rp_ID;
			...
			return (webs_YueyxShop.Model.RushPurchaseBase)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<webs_YueyxShop.Model.RushPurchaseBase> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<webs_YueyxShop.Model.RushPurchaseBase> DataTableToList(DataTable dt)
		{
			List<webs_YueyxShop.Model.RushPurchaseBase> modelList = new List<webs_YueyxShop.Model.RushPurchaseBase>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				webs_YueyxShop.Model.RushPurchaseBase model;
