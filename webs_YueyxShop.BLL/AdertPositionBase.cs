...
namespace webs_YueyxShop.BLL
{
    ...
    {
        private readonly IAdertPositionBase dal = DataAccess.CreateAdertPositionBase();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Model.AdertPositionBase GetModelByCache(int p_ID)
        {

            string CacheKey = "AdertPositionBaseModel-" + p_ID;
            ...
            return (Model.AdertPositionBase)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.AdertPositionBase> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.AdertPositionBase> DataTableToList(DataTable dt)
        {
            List<Model.AdertPositionBase> modelList = new List<Model.AdertPositionBase>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.AdertPositionBase model;
