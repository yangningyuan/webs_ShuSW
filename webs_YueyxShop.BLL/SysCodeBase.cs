...
namespace webs_YueyxShop.BLL
{
	...
	{
		private readonly ISysCodeBase dal=DataAccess.CreateSysCodeBase();
		public SysCodeBase()
		{}
		#region  BasicMethod
		/// <summary>
		...
		{
			return dal.DeleteList(Common.PageValidate.SafeLongFilter(sc_IDlist,0) );
		}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public webs_YueyxShop.Model.SysCodeBase GetModelByCache(Guid sc_ID)
		{
			
			string CacheKey = "SysCodeBaseModel-" + sc_ID;
			...
			return (webs_YueyxShop.Model.SysCodeBase)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<webs_YueyxShop.Model.SysCodeBase> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<webs_YueyxShop.Model.SysCodeBase> DataTableToList(DataTable dt)
		{
			List<webs_YueyxShop.Model.SysCodeBase> modelList = new List<webs_YueyxShop.Model.SysCodeBase>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				webs_YueyxShop.Model.SysCodeBase model;
