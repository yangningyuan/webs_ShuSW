...
namespace Common.DBHelper
{
    public class SQLHelper
    {
        ...
        public static DataSet GetDataSetProc(string ProcName, ref SqlParameter[] pas)
        {
            DataSet dt = new DataSet(); ;
            using (SqlConnection conn = new SqlConnection(strConn))
            {
                ...
                foreach (SqlParameter item in pas)
                {
        ...
        public static int ExecProc(string ProcName, ref SqlParameter[] pas)
        {
            int i = 0;
            using (SqlConnection conn = new SqlConnection(strConn))
            {
