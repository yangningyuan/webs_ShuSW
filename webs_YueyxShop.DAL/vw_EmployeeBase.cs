...
{
	/// <summary>
	/// 数据访问类:vw_EmployeeBase
	/// </summary>
	public partial class vw_EmployeeBase:Ivw_EmployeeBase
	{
		...
		public bool Add(webs_YueyxShop.Model.vw_EmployeeBase model)
		{
			...
			strSql.Append("insert into vw_EmployeeBase(");
			strSql.Append("e_ID,d_ID,d_MingCh,e_YongHM,e_MiM,e_MingC,e_GongH,e_XingB,e_ShengR,e_QQ,e_EMail,e_ShouJ,e_CreatedBy,e_CreatedOn,e_StateCode,e_DeleteStateCode,e_LeiB)");
			...
			parameters[3].Value = model.e_YongHM;
			parameters[4].Value = model.e_MiM;
			parameters[5].Value = model.e_MingC;
			parameters[6].Value = model.e_GongH;
			parameters[7].Value = model.e_XingB;
			parameters[8].Value = model.e_ShengR;
			parameters[9].Value = model.e_QQ;
			parameters[10].Value = model.e_EMail;
			parameters[11].Value = model.e_ShouJ;
			parameters[12].Value = Guid.NewGuid();
			parameters[13].Value = model.e_CreatedOn;
			parameters[14].Value = model.e_StateCode;
			parameters[15].Value = model.e_DeleteStateCode;
			parameters[16].Value = model.e_LeiB;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update vw_EmployeeBase set ");
			...
			parameters[10].Value = model.e_EMail;
			parameters[11].Value = model.e_ShouJ;
			parameters[12].Value = model.e_CreatedBy;
			parameters[13].Value = model.e_CreatedOn;
			parameters[14].Value = model.e_StateCode;
			parameters[15].Value = model.e_DeleteStateCode;
			parameters[16].Value = model.e_LeiB;
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from vw_EmployeeBase ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		public webs_YueyxShop.Model.vw_EmployeeBase GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 e_ID,d_ID,d_MingCh,e_YongHM,e_MiM,e_MingC,e_GongH,e_XingB,e_ShengR,e_QQ,e_EMail,e_ShouJ,e_CreatedBy,e_CreatedOn,e_StateCode,e_DeleteStateCode,e_LeiB from vw_EmployeeBase ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			webs_YueyxShop.Model.vw_EmployeeBase model=new webs_YueyxShop.Model.vw_EmployeeBase();
		...
		/// 得到一个对象实体
		/// </summary>
		public webs_YueyxShop.Model.vw_EmployeeBase DataRowToModel(DataRow row)
		{
			webs_YueyxShop.Model.vw_EmployeeBase model=new webs_YueyxShop.Model.vw_EmployeeBase();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select e_ID,d_ID,d_MingCh,e_YongHM,e_MiM,e_MingC,e_GongH,e_XingB,e_ShengR,e_QQ,e_EMail,e_ShouJ,e_CreatedBy,e_CreatedOn,e_StateCode,e_DeleteStateCode,e_LeiB ");
			strSql.Append(" FROM vw_EmployeeBase ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM vw_EmployeeBase ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from vw_EmployeeBase T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "vw_EmployeeBase";
