...
using webs_YueyxShop.Web.Controllers.Wap;

namespace webs_YueyxShop.Web.Controllers.ShuSW
{
    public class sswOrderController : Controller
    {
        ...
        public MemberBase mimodel = null;
        # region 订单
        ...
        public ActionResult Order()
        {
            ...
            else
            {
                ...
                GetShipType();
                //获取折扣
                ViewData["discount"] = GetMemberDisCount(mimodel.m_ID);
                //加载收货地址
                GetConsigneeInfo();
                return View();
            }
