...
function OpenWindow(url) {
    if (url.substr(0, 1) == "/") {
        //window.open(window.MVCURL + url);
        window.location.href = window.MVCURL + url;
    }else {
        //window.open(window.MVCURL + "/" + url);
        window.location.href = window.MVCURL + "/" + url;
    }
...
var LOADINGGIF = "<div style=\"text-align:center; margin-top:10px;\"><img src='../Content/default/images/loading.gif' alt=''/></div>";